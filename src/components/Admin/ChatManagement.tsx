...
const iconOptions = [
  ...
  { value: 'Person', label: 'Персона', icon: PersonIcon },
  { value: 'Group', label: 'Группа', icon: GroupIcon },
  { value: 'School', label: 'Образование', icon: SchoolIcon },
  { value: 'Work', label: 'Работа', icon: WorkIcon },
  { value: 'Home', label: 'Дом', icon: HomeIcon },
  { value: 'Star', label: 'Избранное', icon: StarIcon },
  { value: 'Music', label: 'Музыка', icon: MusicIcon },
  { value: 'Movie', label: 'Фильмы', icon: MovieIcon },
  { value: 'Book', label: 'Книги', icon: BookIcon },
  { value: 'Pets', label: 'Питомцы', icon: PetsIcon },
  { value: 'Sports', label: 'Спорт', icon: SportsIcon },
  { value: 'Food', label: 'Еда', icon: FoodIcon },
  { value: 'Travel', label: 'Путешествия', icon: TravelIcon },
  { value: 'Code', label: 'Программирование', icon: CodeIcon },
  { value: 'Money', label: 'Финансы', icon: MoneyIcon },
  { value: 'Gift', label: 'Подарки', icon: GiftIcon },
  { value: 'Lightbulb', label: 'Идеи', icon: LightbulbIcon },
  { value: 'Warning', label: 'Важно', icon: WarningIcon },
];
